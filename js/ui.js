// =========================================================================
// AMS PRO - REAL-TIME UI RENDERING ENGINE (MODULAR V1 - REPAIRED)
// =========================================================================
...
(function(window) {
    ...
    function renderUnitListRow(unitArray, bookings) {
        ...
        return `
            <div class="d-flex align-items-center justify-content-between py-2 border-bottom">
                <div class="d-flex align-items-center gap-3">
                    <img src="${imageSrc}" alt="${tipe}" class="rounded-3 border" style="width: 50px; height: 50px; object-fit: cover;" onerror="this.onerror=null; this.src='${fallbackUrl}';">
                    <div>
                        ...
                        <small class="${status === 'rent' ? 'text-success fw-bold' : 'text-muted'}">
                            ${status === 'rent' ? `<i class="fas fa-user me-1"></i>${penyewaAktif || 'Sedang disewa'}` : `<i class="fas fa-check-circle me-1"></i>Standby`}
                        </small>
                    </div>
                </div>
    ...
    /**
     * 📅 FORMAT TANGGAL PENDEK: Mempercantik format waktu
     */
